...
class Withdraw(tk.Frame):
    def __init__(self, parent, controller):
        ...
        cash = tk.StringVar()
        amount_entry = tk.Entry(self, textvariable=cash, width=59, justify='center')
        ...
        enter = tk.Button(self, text='Enter', command=amount, relief='raised', borderwidth=1, width=60, height=3, bg='#da0000', fg='white')
        enter.pack(pady=10)
